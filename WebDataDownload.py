...
class MutlipleWebDataDownload:
    ...
    def MainFunction(self):
        ...
        root.title("Website Data Scrapping")
        ...
        lbl1 = tk.Label(frame, text='Enter Excel \n file path: ', font=('comicsansms', 9, 'bold'))
        lbl1.place(relx=0.02, rely=0.1, relwidth=0.20, relheight=0.1)

        filePath = tk.StringVar(frame)
        filePathEntry = tk.Entry(frame, textvariable=filePath, font=('comicsansms', 8))
        filePathEntry.place(relx=0.25, rely=0.1, relwidth=0.72, relheight=0.1)

        btn = tk.Button(root, text="Download data", bg='#a2c49e', command=btnClick, font=1)
        btn.place(relx=0.3, rely=0.4, relheight=0.1, relwidth=0.3)

        lower_frame = tk.Frame(root, bg='#ffde00', bd=5)
        lower_frame.place(relx=0.5, rely=0.60, relwidth=0.85, relheight=0.30, anchor='n')
        ...
        def loopPartNum():
            ...
            deutsch_dict = {}
            yazaki_dict = {}
            path = excelPath + r'\Multiple_Data_Download.xlsx'
        ...
        def putAttibuteValuesInExcel(r_no, attrib_value, wb_path, sh_name, col_num, part_no,
                                     website_name, euRohs_data, statusValue):
            wbkName = wb_path
        ...
        def putValuesInTemplateFile(drawMsg, stepMsg, attributeMsg, statusMsg, row_num):
            wbkName = excelPath + r'\Multiple_Data_Download.xlsx'
        ...
        def TEAutomateTask(tyco_dict, website_name):
            ...
            prefs = {
                "download.default_directory": excelPath + r'\Tyco',
            ...
            for part in tyco_dict.items():
                ...
                wb_name = excelPath + r'\Attribute Files\Tyco_Attribute_Data.xlsx'
                sht_name = 'Data'
                    ...
                    try:
                        ...
                        for link in range(len(link_part)):
                            if driver.find_elements_by_xpath(
                                    '//div[@id="te-body"]//div//section[3]//table/tbody//div//span/a')[
                                link].text == partNo:
                                link_element = driver.find_elements_by_xpath(
                                    '//div[@id="te-body"]//div//section[3]//table/tbody//div//span/a')[link]
                                driver.execute_script("arguments[0].click();", link_element)
                    except:
                        try:
                            link_part2 = driver.find_elements_by_xpath(
                                "//div[@id='te-body']//div[@class='table-inner-div']//span[@class='internal-number product-values']")
                            print("Link part 2 len : ", len(link_part2))
                            for lnk in range(len(link_part2)):
                                if driver.find_elements_by_xpath(
                                        "//div[@id='te-body']//div[@class='table-inner-div']//span[@class='internal-number product-values']")[
                                    lnk].text == partNo:
                                    link_element2 = driver.find_elements_by_xpath(
                                        "//div[@id='te-body']//div[@class='table-inner-div']//span[@class='internal-number product-values']/parent::p/preceding-sibling::a")[
                                        lnk]
                        ...
                        try:
                            link_part3 = driver.find_elements_by_xpath(
                                "//div[@id='te-page']//div[@class='table2-inner-div2']//td[@class='ng-scope']//a")
                            for lnk2 in range(len(link_part3)):
                                if driver.find_elements_by_xpath(
                                        "//div[@id='te-page']//div[@class='table2-inner-div2']//td[@class='ng-scope']//a")[
                                    lnk2].text == partNo:
                                    link_element3 = driver.find_elements_by_xpath(
                                        "//div[@id='te-page']//div[@class='table2-inner-div2']//td[@class='ng-scope']//a")[
                                        lnk2]
                ...
                if driver.find_elements_by_xpath(documentsXpath):
                    ...
                    statusObsoleteValue = driver.find_element_by_xpath(
                        "//ul[@class='statusContainer']//a[@id='dyn']//span").text

                    if driver.find_element_by_xpath(
                            "//ul[@class='statusContainer']//a[@id='dyn']//span").text == "ACTIVE":
                        ...
                        try:
                            # get status
                            statusValue = driver.find_element_by_xpath(
                                "//ul[@class='statusContainer']//a[@id='dyn']//span").text
                            ...
                            for i in range(pd_row_num):
                                ...
                                try:
                                    ...
                                    putAttibuteValuesInExcel(i, attrib_value, path, sht_name, colm_num, partNo,
                                                             website_name, euRoHS_data, statusValue)
        ...
        def MolexAutoTask(molex_dict, website_name):
            ...
            chromeOptions = Options()
            prefs = {
                "download.default_directory": excelPath + r'\Molex',
                "plugins.always_open_pdf_externally": True
            }
            chromeOptions.add_experimental_option("prefs", prefs)
            ...
            for part in molex_dict.items():
                ...
                searchButtonXpathStartPage = "//*[@id='billboard-search-area']//button[contains(text(), 'Search')]"
                searchBtnXpath = "//button[@class='btn btn-primary btn-plain' and @type='submit' and text()='Search']"
                serachBtnInsideXpath = "//*[@id='main-menu']//a[@href='#search-form']"
                ...
                mates_data = []
                euRohs_data = ''
                workbook_path = excelPath + r'\Attribute Files\Molex_Attribute_Data.xlsx'
                ...
                try:
                    if cnt == 0:
                        # inserting part number first time opening the Molex website
                        partNoElement = driver.find_element(By.ID, partNoID)
                        partNoElement.clear()
                        partNoElement.send_keys(partNo)
                    else:
                        # inserting part number in already opened Molex page
                        # partNoElement = driver.find_element(By.ID, partNoInsideId)
                        partNoElement = driver.find_elements_by_id(partNoInsideId)[1]
                        partNoElement.clear()
                        partNoElement.send_keys(partNo)

                    if cnt == 0:
                        # clicking on search button first time Molex page in open
                        searchButtonElement = driver.find_element(By.XPATH, searchButtonXpathStartPage)
                        searchButtonElement.click()
                    else:
                        # clicking on search button in already opened Molex page
                    ...
                    if driver.find_elements_by_xpath("//div[@id='part-overview']//strong[text()='Status:']"):
                        ...
                        try:
                            driver.execute_script(
                                "document.getElementsByClassName('btn btn-primary js_expand_all')[0].click()")
                            time.sleep(2)
                        except:
                            putValuesInTemplateFile('No', 'No', 'No', "Yes", row_num)
                            pass
                        ...
                        try:
                            ...
                            if driver.find_element_by_xpath(
                                    statusXpath).text == 'Active' or driver.find_element_by_xpath(
                                statusXpath).text == "Active - Custom":
                                ...
                                for i in range(pd_row_num):
                                    ...
                                    try:
                                        ...
                                        attrib_value = attrib_value_row.loc[attrib_index, 'Values']
                                        putAttibuteValuesInExcel(i, attrib_value, path, sht_name, col_num, partNo,
                                                                 website_name, euRohs_data, 'Status')
                                    except:
                                        continue
                                    ...
                                    try:
                                        ...
                                        pd_transpose.to_excel(writer, sheet_name=sht_name, header=None, index=False,
                                                              startrow=pd_row_num + 1,
        ...
        def AptivAutomateTask(aptiv_dict, website_name):
            ...
            prefs = {
                "download.default_directory": excelPath + r'\Aptiv(Delphi)',
                "plugins.always_open_pdf_externally": True
            }
            ...
            for part in aptiv_dict.items():
                ...
                cookiesXpath = "//button[@class='optanon-allow-all accept-cookies-button' and @title='Accept Cookies']"
                cookiesXpath2 = "//button[@id='tracking-consent-dialog-accept']"
                ...
                tb_data = []
                tb_related_data = []
                wrk_book_path = excelPath + r'\Attribute Files\Aptiv(Delphi)_Attribute_Data.xlsx'
                sht_name = "Data"
                ...
                ################## Accept cookies outer #################
                try:
                    # cookiesElement = driver.find_element(By.CSS_SELECTOR, cookiesCssSelector)
                    # cookiesElement.click()
                    cookiesElement = driver.find_element(By.XPATH, cookiesXpath)
                    cookiesElement.click()
                ...
                try:
                    # cookiesElement = driver.find_element(By.CSS_SELECTOR, cookiesCssSelector)
                    # cookiesElement.click()
                    cookiesElement2 = driver.find_element(By.XPATH, cookiesXpath2)
                    cookiesElement2.click()
                    # driver.execute_script("arguments[0].click();", cookiesElement)
                except Exception as e:
                    print(e)
                    pass
                ...
                # Checks whether supplier part is found or not
                try:
                    ################## Accecpt Cookies Outer #######################
                    try:
                        cookiesElement = driver.find_element(By.XPATH, cookiesXpath)
                        cookiesElement.click()
                    except Exception as e:
                    ...
                    if zeroResultElement == partNo:
                        ...
                        # click on supplier part nuber image
                        ...
                        try:
                            ...
                            try:
                                ...
                                pd_related.to_csv(excelPath + r'\Attribute Files\Aptive.csv',
                                                  index=False)
                                pd_csv = pd.read_csv(excelPath + r'\Attribute Files\Aptive.csv')
                                ...
                                writer.book = book
                                writer.sheets = dict((ws.title, ws) for ws in book.worksheets)
                                pd_csv.to_excel(writer, sheet_name=sht_name, header=None, index=False,
                                                startrow=pd_row_num,
                                                startcol=col_num - 1, encoding='utf-8')
                                writer.save()
                            except Exception as e:
                            ...
                            try:
                                os.remove(excelPath + r'\Attribute Files\Aptive.csv')
                            except Exception as e:
                                print(e)
                        ...
                        try:
                            if driver.find_elements_by_xpath(drawingXpath):
                                ...
                                if driver.find_elements(By.CSS_SELECTOR, drawingTiffCssSelector)[0]:
                                    drawingElementTiff = driver.find_elements(By.CSS_SELECTOR, drawingTiffCssSelector)[
                                        0]
                                    ...
                                    drawingElementTiff2 = driver.find_elements(By.CSS_SELECTOR, drawingTiffCssSelector)[
                                        1]
        ...
        def Deutsch(deutsch_dict, website_name):
            ...
            chromeOptions = Options()
            prefs = {
                "download.default_directory": excelPath + r'\Deutsch',
                "plugins.always_open_pdf_externally": True
            }
            chromeOptions.add_experimental_option("prefs", prefs)
            driver = webdriver.Chrome(executable_path=ChromeDriverManager().install(), options=chromeOptions)
            ...
            for part in deutsch_dict.items():
                ...
                wb_name = excelPath + r'\Attribute Files\Deutsch_Attribute_Data.xlsx'
                sht_name = "Data"
        ...
        def Yazaki(yazaki_dict, website_name):
            ...
            chromeOptions = Options()
            prefs = {
                "download.default_directory": excelPath + r'\Yazaki',
                "plugins.always_open_pdf_externally": True
            }
            chromeOptions.add_experimental_option("prefs", prefs)
            driver = webdriver.Chrome(executable_path=ChromeDriverManager().install(), options=chromeOptions)
            ...
            for part in yazaki_dict.items():
                ...
                wb_path = excelPath + r'\Attribute Files\Yazaki_Attribute_Data.xlsx'
                sht_name = "Data"
